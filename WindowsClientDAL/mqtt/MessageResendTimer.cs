...
{
    public class MessageResendTimer
    {
        ...
        public MessageResendTimer(MQMessage message, TCPClient client, TimersMap timersMap)
        {
            if (message.GetMessageType() == avps.MessageType.CONNECT)
