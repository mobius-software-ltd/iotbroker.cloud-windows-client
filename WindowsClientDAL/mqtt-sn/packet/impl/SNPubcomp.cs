...
{
    public class SNPubcomp: CountableMessage
    {
        ...
        public SNPubcomp(Int32 messageID) :base(messageID)
        {            
        }
        ...
        public SNPubcomp reInit(Int32 messageID)
        {
        ...
        {
            device.ProcessPubcomp(MessageID.Value);
        }
