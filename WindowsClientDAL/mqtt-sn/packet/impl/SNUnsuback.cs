...
{
    public class SNUnsuback: CountableMessage
    {
        ...
        public SNUnsuback(Int32 messageID) :base(messageID)
        {           
        }
        ...
        public SNUnsuback reInit(Int32 messageID)
        {
        ...
        {
            device.ProcessUnsuback(MessageID.Value);
        }
