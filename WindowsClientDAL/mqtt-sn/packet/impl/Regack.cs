...
{
    public class Regack : CountableMessage
    {
        ...
        public Regack(Int32 topicID, Int32 messageID, ReturnCode code):base(messageID)
        {
        ...
        public Regack reInit(Int32 topicID, Int32 messageID, ReturnCode code)
        {
            this._topicID = topicID;
        ...
        {
            device.ProcessRegack(MessageID.Value,topicID,code);
        }
