...
{
    public class SNPubrel: CountableMessage
    {
        ...
        public SNPubrel(Int32 messageID) :base(messageID)
        {            
        }
        ...
        public SNPubrel reInit(Int32 messageID)
        {
        ...
        {
            device.ProcessPubrel(MessageID.Value);
        }
