...
{
    public class DeliveryAnnotations : AMQPSection
    {
        ...
        public TLVAmqp getValue()
        {
            ...
            DescribedConstructor constructor = new DescribedConstructor(map.Code, new TLVFixed(AMQPType.SMALL_ULONG, new byte[] { 0x71 }));
        ...
        public void addAnnotations(Object key, Object value)
        {
            ...
            if (key is String)
			    ...
			    throw new ArgumentException("DeliveryAnnotations keys are restricted to types Symbol and ULong. Received key type: " + key.GetType());
        }
