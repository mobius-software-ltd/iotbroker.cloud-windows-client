...
{
    public class AMQPEncoder : MessageToByteEncoder<AMQPHeader>
    {
        protected override void Encode(IChannelHandlerContext context, AMQPHeader message, IByteBuffer output)
        {
            IByteBuffer buf = AMQPParser.Encode(message);
